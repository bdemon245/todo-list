            ...
            <header class="w-full mb-10">
                ...
                <form action={{route('item.store')}} method="post" class="w-full">
                    ...
                    <div class="flex gap-4" >
                        <input class="focus:ring-2 grow focus:ring-blue-500 focus:outline-none appearance-none w-full text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-md py-2 pl-10 ring-slate-200 shadow-sm" type="text" aria-label="Filter projects" placeholder="Add new list..."
                        name="item" value=""> 
